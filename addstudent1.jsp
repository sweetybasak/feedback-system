...
<body bgcolor="cyan">
    ...
    <form name="addteacher" action="addnewstudent1.jsp" method="post"  >
<center>
...
<tr>
<th align=left>Enter Name :</th><td align=left><input type=text name="sname" size="30" ></td>
</tr>
<tr>
       <%
...
<tr>
<th align=left>Enter UserName :</th><td align=left><input type=text name="suname" size="20" ></td>
</tr>
<tr>
	<th align=left>Password :</th>
	<td align=left><input name="spw" type=password size="20" ><br></td>
</tr>
