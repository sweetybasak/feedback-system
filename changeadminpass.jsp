...
<font color=BLUE><MARQUEE WIDTH=100% BEHAVIOR=ALTERNATE bgcolor=yellow><b>CHANGE ADMIN PASSWORD</b></MARQUEE></font><br><br>
<br><br>
<table width="50%" border="0" align="center" cellpadding="5" cellspacing="5"> 
<tr>
<th align=left>UserName :</th><td align=left><input type=text name=aduname size=30></td>
</tr>
<tr>
<th align=left>Old Password :</th><td align=left><input type=password name=adpw size=30></td>
</tr>
<tr>
<th align=left>New Password :</th><td align=left><input type=password name=passwd2 size=30></td>
</tr>
<tr>
...
try{
	...
	int flag=0, flag1=0;
	str1=request.getParameter("aduname");
	str2=request.getParameter("adpw");
	...
	if(str3.compareTo(str4)==0)
	{
		...
		if(flag==1 && flag1==1)
		{
			sql = "update admin set adpw='"+str3+"' where aduname='"+str1+"'";
			st.execute(sql);
			response.sendRedirect("adminhome.html?username="+str1);
		}
		else if(flag==0)
		{
