...
<tr>
<th align=left>UserName :</th><td align=left><input type=text name=tname size=30></td>
</tr>
<tr>
<th align=left>Old Password :</th><td align=left><input type=password name=tpw size=30></td>
</tr>
<tr>
...
try{
	...
	if(str3.compareTo(str4)==0)
	{
		...
		while(rs.next())
		{
			str=rs.getString("tuname");	
			str5=rs.getString("tpw");
		...
		if(flag==1 && flag1==1)
		{
			sql = "update teacher set tpw='"+str3+"' where tuname='"+str1+"'";
			st.execute(sql);
